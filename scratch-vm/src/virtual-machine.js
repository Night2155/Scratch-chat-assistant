...
class VirtualMachine extends EventEmitter {
    ...
    loadProject(input) {
        ...
        return validationPromise
            ...
            .then(() => {
                ...
                if (loaded == 2) {
                    console.log('讀取完成');
                    // document.getElementsByClassName("menu_menu-item_3EwYA menu_hoverable_3u9dt")[2].click(); // 首次先儲存專案
                    document.getElementById("downloadSB3").click(); // 首次先儲存專案
                }
            })
            .catch(error => {
    ...
    saveProjectSb3() {
        ...
        var file = new Blob([projectJson], { type: type });
        ...
        var storageRef = storage.ref(`${localStorage.identity}/${classno}/${userno}/Projects/${projName}/project.json`);
        storageRef.put(file);
